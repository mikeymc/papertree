...
def create_strategy(user_id):
    ...
    try:
        ...
        strategy_id = deps.db.create_strategy(
            ...
            conditions={**data.get('conditions', {}), 'analysts': data.get('analysts', ['lynch', 'buffett'])},
...
def update_strategy(user_id, strategy_id):
    ...
    try:
        ...
        success = deps.db.update_strategy(
            ...
            name=data.get('name'),
            description=data.get('description'),
            conditions={**data['conditions'], 'analysts': data.get('analysts')} if data.get('conditions') and 'analysts' in data else data.get('conditions'),
