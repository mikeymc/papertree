...
class BriefingGenerator:
    ...
    def generate(
        ...
        briefing = {
            ...
            'universe_size': run.get('universe_size', 0),
            'candidates': run.get('candidates', 0),
            'qualifiers': run.get('qualifiers', 0),
            'theses': run.get('theses', 0),
            'targets': run.get('targets', 0),
    ...
    def _generate_executive_summary(self, briefing: Dict[str, Any]) -> str:
        ...
        try:
            ...
            prompt = prompt_template.format(
                ...
                theses=briefing.get('theses', 0),
                targets=briefing.get('targets', 0),
                trades=briefing.get('trades', 0),
